...
import booksPageInitialPaths5e40fResource from '../../resources/books-page-initial-paths-5e40f'
import booksPageInitialPropsA0929Resource from '../../resources/books-page-initial-props-a0929'
  ...
  return (
    <>
      <div className="books11-container">
        <Head>
          <title>Books1 - Dynamic Factors Liaison</title>
          <meta
            property="og:title"
            content="Books1 - Dynamic Factors Liaison"
          />
        </Head>
        <DataProvider
...
export async function getStaticPaths() {
  const response = await booksPageInitialPaths5e40fResource({})
  return {
...
export async function getStaticProps(context) {
  const response = await booksPageInitialPropsA0929Resource({
    ...context?.params,
  })
  return {
    props: {
